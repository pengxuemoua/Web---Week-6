...
let zoomLevel = 1 // orginally I set this to 4, but with the large array, I had to use 1 
...
// bridges = [
//     {"name": "Verrazano-Narrows Bridge", "address": "New York, NY", "span" : 1298.4, "location": [40.6066, -74.0447] },
//     {"name": "Golden Gate Bridge", "address": "San Francisco and Marin, CA", "span" : 1280.2, "location": [37.8199, -122.4783] }, 
//     {"name": "Mackinac Bridge", "address": "Mackinaw and St Ignace, MI", "span" : 1158.0, "location": [45.8174, -84.7278] }, 
//     {"name": "George Washington Bridge" ,"address": "New York, NY and New Jersey, NJ", "span" : 1067.0, "location": [40.8517, -73.9527] },
//     {"name": "Tacoma Narrows Bridge", "address": "	Tacoma and Kitsap, WA", "span" : 853.44, "location": [47.2690, -122.5517] }
// ]

bridges = [// I commented out the orginal array to test this array. Scroll down to line 993
    {
...
// get bridge picture and set size
...
bridges.forEach(function(usBridges) {
    ...
    L.marker(usBridges.location, {icon: bridgeIcon} ).bindPopup(markerText).addTo(map)
})

// I was trying to see how I could get the largest span but couldn't wrap my head around it
let bridgeSpans = []
...
// an array of colors, will be used for the chart js of bridges
let chartColors = [ 'tomato', 'orange', 'dodgerblue', 'mediumseagreen', 'slateblue', 'violet' ]

// create function to all data to the chart js
function addBridgeToChart(bridge, span) {
    bridgeChart.data.labels.push(bridge)
...
// loop through the bridges array and call function to update the chart js
for (let i = 0 ; i < bridges.length; i++) {
    let nameLength = bridges[i].name
    let spanNumber = bridges[i].span

    addBridgeToChart(nameLength,spanNumber)
}
